            ...
            <div class="modal-body p-4">
                ...
                <form method="POST" action="/login">
                    ...
                    <div class="mb-3 position-relative">
                        <input type="password" name="password" id="loginPass" class="form-control rounded-3"placeholder="Password" required>
                        <i class="bi bi-eye position-absolute" style="right:15px; top:50%; transform:translateY(-50%); cursor:pointer;" onclick="togglePassword('loginPass', this)"></i>
                    </div>
                    ...
                    <p class="text-center small mt-3">
                        Belum punya akun?
                        <a href="#" data-bs-toggle="modal"data-bs-target="#registerModal"data-bs-dismiss="modal"style="color:#1b2a41;">
                            Daftar
                        </a>
                    </p>
                </form>
